...
public class Constants {
    ...
    public final static String STORE_PATH = System.getProperty("store.path", "/tmp");  // TODO: 这里要改
    ...
    public final static int PRO_MAX = Integer.valueOf(System.getProperty("pro.max","4000000"));   //原始是10000
